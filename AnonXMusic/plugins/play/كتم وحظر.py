...
gaaof = []
@app.on_message(filters.command(["تعطيل الحظر", "تعطيل الطرد", "تعطيل الحمايه"], "") & filters.group)
...
@app.on_message(filters.command(["فتح الطرد", "تفعيل الطرد", "تفعيل الحظر", "تفعيل الحمايه"], "") & filters.group)
